...
- **Submission received and confirmed:** PS7 — Coinbase submission received 19 Jun 2026, rewritten by Siva Ramanathan (GFTN); presenter confirmed as Chad Harper (Head of Coinbase Institute)
...
**PS7 received and reframed (19 Jun 2026):** Coinbase's reframing shifts the core problem from DeFi governance to the access gap — the absence of an interoperability and compliance framework connecting operational but siloed tokenised capital markets infrastructure. Submission rewritten by Siva Ramanathan (GFTN) based on Coinbase's 19 June 2026 input. Presenter confirmed as Chad Harper (not Scott Bauguess). Working group assignment moved from WG2 to WG1.

## Problem Statement Detail

### PS7 — Interoperability Conditions for Inclusive, Cross-Border Asset Access
**Presenter:** Chad Harper, Head of Coinbase Institute *(confirmed; replaces Scott Bauguess)*
...
**Submission status:** Received 19 June 2026. Rewritten by Siva Ramanathan (GFTN) based on Coinbase input. Confirmed by Coinbase via email 19 June 2026.
...
- Token standards for regulated equities: ERC-3643 exists but lacks a globally recognised cross-platform interoperability framework
...
**Evidence anchors:**
- DTCC DTC Tokenisation Service (SEC No-Action Letter Dec 2025; production trades July 2026; 50+ firms incl. BlackRock, JPMorgan, Goldman Sachs)
